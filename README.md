...
## Home Pricing Model
I worked to create a multilinear regression model in R to predict home prices in Oregon utilizing both quantitative and qualitative variables. After performing preliminary data exploration, I implemented techniques such as 
